/*
 * @Author: cpu_code
 * @Date: 2020-05-19 18:38:54
 * @LastEditTime: 2020-05-19 18:42:43
 * @FilePath: \Linux_driver\include\arch\arm\kernel\setup.c
...
/** 
 *Linux 内核调用 start_kernel 函数来启动内核， 
 *start_kernel 函数会调用 setup_arch 函数来匹配 machine_desc 
 */
