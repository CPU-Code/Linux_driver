/*
 * @Author: cpu_code
 * @Date: 2020-05-24 18:04:41
 * @LastEditTime: 2020-05-25 15:43:20
 * @FilePath: \Linux_driver\9spinlock\spinlock.c
...
static int __init led_init(void)
{
    ...
    cdev_init(&gpioled.cdev, &gpioled_fogs);
