/*
 * @Author: cpu_code
 * @Date: 2020-06-03 10:09:52
 * @LastEditTime: 2020-06-03 17:16:09
 * @FilePath: \Linux_driver\code\asyncnoti\asynconti.c
...
/**
 * @function: 应用程序调用close关闭驱动文件的时候会执行
 * @parameter: 
 *      inode	: inode节点
 *      filp    : 要打开的设备文件(文件描述符)
 * @return: 
